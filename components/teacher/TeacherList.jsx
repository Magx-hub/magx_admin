...
const TeacherList = ({ 
  ...
  // Render teacher item as table row
  const renderTeacher = ({ item }) => (
    <TouchableOpacity 
      style={[
        STYLES.tableRow, 
        selectedTeacher?.id === item.id && { backgroundColor: COLORS.primaryLight }
      ]}
  ...
  if (error) {
    return (
      <View style={STYLES.errorState}>
        ...
        <Text style={STYLES.errorTitle}>Error Loading Teachers</Text>
    ...
    <View style={STYLES.container}>
      ...
      >
        ...
        <View style={styles.tableContainer}>
          {filteredTeachers.length > 0 && renderTableHeader()}
          <FlatList
            ...
            contentContainerStyle={[
              filteredTeachers.length === 0 && styles.emptyListContainer
            ]}
            showsVerticalScrollIndicator={false}
        ...
        {/* Teacher Details Panel - Outside table container for proper scrolling */}
